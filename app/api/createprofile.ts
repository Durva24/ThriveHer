...
const groq = new Groq({
  apiKey: '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', // Replace with your actual Groq API key
...
export class ProfileAPI {
  ...
  private static readonly GROQ_API_KEY = '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'; // Replace with your actual Groq API key
