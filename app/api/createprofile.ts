...
const groq = new Groq({
  apiKey: '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', // Replace with your actual Groq API key
...
export class ProfileAPI {
  ...
  private static readonly GROQ_API_KEY = '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'; // Replace with your actual Groq API key
